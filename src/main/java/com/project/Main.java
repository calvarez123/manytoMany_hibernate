...
Manager.updatePersona(per0.getPersonaId(), 
    per0.getDni(), per0.getNom(), per0.getTelefon());
...
Manager.updatePersona(per1.getPersonaId(), 
    per1.getDni(), per1.getNom(), per1.getTelefon());
...
Manager.updatePersona(per2.getPersonaId(), 
    per2.getDni(), per2.getNom(), per2.getTelefon());
...
Manager.updatePersona(per3.getPersonaId(), 
    per3.getDni(), per3.getNom(), per3.getTelefon());
...
Manager.updatePersona(per4.getPersonaId(), 
    per4.getDni(), per4.getNom(), per4.getTelefon());
...
Manager.updatePersona(per5.getPersonaId(), 
    per5.getDni(), per5.getNom(), per5.getTelefon());
...
Manager.updatePersona(per6.getPersonaId(), 
    per6.getDni(), per6.getNom(), per6.getTelefon());
...
Manager.updatePersona(per7.getPersonaId(), 
    per7.getDni(), per7.getNom(), per7.getTelefon());
...
Manager.updateAutor(aut0.getAutorId(), aut0.getNom());
...
Manager.updateAutor(aut1.getAutorId(), aut1.getNom());
...
Manager.updateAutor(aut2.getAutorId(), aut2.getNom());
...
Manager.updateAutor(aut3.getAutorId(), aut3.getNom());
...
System.out.println(Manager.collectionToString(Autor.class, Manager.listCollection(Autor.class)));
System.out.println(Manager.collectionToString(Persona.class, Manager.listCollection(Persona.class)));
